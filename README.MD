...
| **TDD (база)**           | Initial testing practice: JUnit, writing simple tests. Mastering the red-green-refactor pattern. | – [TDD Extreme programming ](https://habr.com/ru/companies/piter/articles/326662/) </br> –  [JUnit 5 Docs](https://junit.org/junit5/docs/current/user-guide/) |
